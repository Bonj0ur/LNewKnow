...
if __name__ == "__main__":
    ...
    files = sorted(os.path.join(args.root_dir, f) for f in os.listdir(args.root_dir) if f.endswith(".json") and f != 'selected_langs.json')
    print(f"\n=== Processing {args.root_dir} ({len(files)} files) ===")
